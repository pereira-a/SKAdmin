...
RegisterServerEvent("skadmin:svincreseWantedLevel")
AddEventHandler("skadmin:svincreseWantedLevel", function(id)
  TriggerClientEvent("skadmin:increseWantedLevel", id)
end)
